...
export class SessionComponent implements OnInit {
  ...
  onEdit(e){
    this.addEditaddressModel = this.modalService.show(AddSessionComponent, { initialState:
  ...
  onDeleteConfirm(event): void {
    ...
    this.warningModel.content.onClose = (cancel) => {
      if (cancel) {
        this.sessionService.Delete(event.data.id).subscribe(res=>{
          if(res.Success){
  ...
  getData(){
    this.sessionService.GetList().subscribe(res=>{this.source.load(res.Data);this.Data=res.Data;;
    });
  }
  addNew() {
    this.addEditaddressModel = this.modalService.show(AddSessionComponent, { initialState:
